...
#error LTMTimer is ARC only. Either turn on ARC for the project or use -fobjc-arc flag
#endif
...
+ (instancetype)scheduledTimerWithTimeInterval:(NSTimeInterval)timeInterval
                                 ...
                                 dispatchQueue:(dispatch_queue_t)dispatchQueue
{
    LTMTimer *timer = [[self alloc] initWithTimeInterval:timeInterval
                                                     target:target
                                                   selector:selector
                                                   userInfo:userInfo
                                                    repeats:repeats
